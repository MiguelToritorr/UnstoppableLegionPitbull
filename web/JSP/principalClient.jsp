<%-- 
    Document   : principalClient
    Created on : 22-nov-2017, 23:52:34
    Author     : Sakai
--%>

<%@page import="Conexion.clients"%>
...
<!--controls hover for videos-->
<script>
    var figure=$(".video2").hover(hoverVideo,hideVideo);
    function hoverVideo(e){
        $('video',this).get(0).function play() {
...
<ul class="menu2">
    <li><s:a  action="dataCount" style="none" id="colorTexto" class="menuhover" > 
                <%
...
<!--    <form action="dataCount" method="post">
        ...
        <input class="btn btn-default" type="submit" value="My account"></input>
    </form>-->
    <!-- slider menu -->
    <div id="slider" id="slide" class="positionSlider">
        <figure>
            <ul >
                <li class="sliderTrans"><s:a action="Image1" title="" ><img src="../Images/Goliath-iloveimg-resized.jpg" class="imagenTamano"></s:a> </li>
...
<div class="mediaInfo">
    ...
    <div class="textVideo">
        ...
        CARE TO KEEP THEM HEALTHY TO
        BRING IT EXCELLENT COMPANIONS OUR CUSTOMERS!!!
        </p>
    </div>
    <div class="mediaP2">
        <video controls>
