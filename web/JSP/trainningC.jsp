<%-- 
    Document   : trainning
    Created on : 06-dic-2017, 17:49:06
    Author     : Sakai
--%>
...
<section class="logoSection">
    <a href="http://localhost:8080/unstoppable/JSP/principalClient.jsp"><img src="../Images/UnsLogo.jpg" alt=""></a>
...
<div>
<ul class="menu">
	<li><a href="http://localhost:8080/unstoppable/JSP/principalClient.jsp" type="menu" class="menuhover" id="colorTexto">HOME</a></li>
</ul>
<ul class="menu2">
    <li><s:a action="Image1" class="menuhover" id="colorTexto">KENNELS</s:a></li>
</ul>
<ul class="menu2">
	<li><a href="http://localhost:8080/unstoppable/JSP/aboutUsC.jsp" class="menuhover" id="colorTexto">ABOUT US</a></li>
</ul>
<ul class="menu2">
